class SubscriptionsController < ApplicationController
  ...
  def find_credit_card
    ...
    @customer = @user.braintree_customer if @user
  ...
  def subscription_path(subscription, options={})
    path ||= user_braintree_customer_credit_card_subscription_path(@user, @credit_card, subscription, options) if @credit_card
